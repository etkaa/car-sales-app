  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt={item.make}
      />
      <div className="py-1 flex flex-col justify-between h-[17%] font-semibold text-lg px-4">
      ...
      <h3 className="h-[8%] font-md text-sm px-4 py-1">{item.listing.listingOwnerId}</h3>
      </div>
    </div>
  );
};
